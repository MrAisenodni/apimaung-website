                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <label for="nama" class="form-label">Nama Penanggap</label>
                                            <input type="text" class="form-control" id="nama" value="{{ $pengaduan->angbpd }}" disabled>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <label for="pesan" class="form-label">Pesan</label>
                                            {{-- <input type="text" class="form-control" id="pesan" disabled value=""> --}}
                                            <textarea name="pesan" class="form-control" id="pesan" cols="30" rows="5" disabled>{{ $pengaduan->balas_pesan }}</textarea>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <button type="button" class="btn btn-info"><a href="/kepdes/pengaduan" class="text-white"><span class="fas fa-times-circle"></span> KEMBALI</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
