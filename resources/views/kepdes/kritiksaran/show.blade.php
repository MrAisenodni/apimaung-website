                            ...
                            <div class="card-body">
                                <form class="row g-3">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <textarea class="form-control" name="pesan" id="pesan" cols="30" rows="5" disabled>{{ $kritiksaran->pesan }}</textarea>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <button type="button" class="btn btn-info"><a href="/kepdes/kritiksaran" class="text-white"><span class="fas fa-times-circle"></span> KEMBALI</a></button>
                                    </div>
                                </form>
                            </div>
                        </div>
