...
<html lang="en">
    <head>
        ...
        <title>@yield('title') | Kepala Desa Pemda E-Government Tengkurak</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="{{ url('kepdes/dashboard') }}">Kepala Desa Web</a>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <a class="nav-link" href="{{ url('/kepdes/dashboard') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Dashboard
                            </a>
                            <a class="nav-link" href="{{ url('/kepdes/pengaduan') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Pengaduan
                            </a>
                            <a class="nav-link" href="{{ url('/kepdes/surat') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div>
                                Surat Online
                            </a>
                            <a class="nav-link" href="{{ url('/kepdes/kritiksaran') }}">
