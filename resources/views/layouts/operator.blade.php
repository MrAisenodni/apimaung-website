...
<html lang="en">
    <head>
        ...
        <title>@yield('title') | Operator Pemda E-Government Tengkurak</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="{{ url('operator/dashboard') }}">Operator PEMDA</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{ url('/operator/pengaduan') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Pengaduan
                            </a>
                            <a class="nav-link" href="{{ url('/operator/surat') }}">
